  ...
  <section id="contact" class="py-20 px-4 md:px-0 bg-card">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex justify-center items-center space-x-6 mb-8">
        ...
        <a href="https://www.linkedin.com/in/wilson-capacho-carmona-a593a1125/" target="_blank" class="hover:text-primary transition-colors">
      ...
      <div class="flex justify-center items-center space-x-4">
        ...
        <a href="/cv_wilson_capacho.pdf" download class="bg-accent hover:bg-accent/80 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">Descargar CV</a>
      </div>
    </div>
  </section>
</template>